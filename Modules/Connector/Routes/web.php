...
Route::middleware('web', 'authh', 'auth', 'SetSessionData', 'language', 'timezone', 'CheckUserLogin')->prefix('connector')->group(function () {
...
Route::middleware('web', 'SetSessionData', 'auth', 'language', 'timezone')->prefix('connector')->group(function () {
