...
<aside class="no-print">
  ...
  <div class="top">
    ...
    <div class="logo">
      @if(file_exists(public_path('uploads/logo.png')))
        <img src="{{ asset('img/pictures/logo.png?v=' . $asset_v) }}" alt="logo" width="140px" class="light-mode-logo" style="display: none;">
        <img src="{{ asset('img/pictures/logo-light.png?v=' . $asset_v) }}" alt="logo" width="140px" class="dark-mode-logo" style="display: none;">
      @else
        <img src="{{ asset('img/pictures/logo.png?v=' . $asset_v) }}" alt="logo" width="140px" class="light-mode-logo" style="display: none;">
        <img src="{{ asset('img/pictures/logo-light.png?v=' . $asset_v) }}" alt="logo" width="140px" class="dark-mode-logo" style="display: none;">
      @endif
  ...
  <div class="sidebar">
    <div class="links">
      ...
      <a href="{{ action([\Modules\Crm\Http\Controllers\DashboardController::class, 'index']) }}" class="{{  'active'  }}">
