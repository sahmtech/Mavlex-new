...
Route::middleware('web', 'authh', 'SetSessionData', 'auth', 'language', 'timezone',  'CheckContactLogin')->prefix('contact')->group(function () {
...
Route::middleware('web', 'authh', 'auth', 'SetSessionData', 'language', 'timezone',  'CheckUserLogin')->prefix('crm')->group(function () {
