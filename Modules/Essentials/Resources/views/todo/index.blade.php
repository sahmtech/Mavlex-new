    ...
    <div class="card-wrapper">
        ...
        <div class="overview-filter">
            ...
            @can('essentials.add_todos')
	            <div class="new-user">
	            	<button type="button" class="add-user-modal-btn btn-modal btn-block btn-primary" data-href="{{action('\Modules\Essentials\Http\Controllers\ToDoController@create')}}" 
