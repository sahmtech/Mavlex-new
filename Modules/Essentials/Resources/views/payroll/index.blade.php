            ...
            <div class="filter">
                    ...
                    <div class="new-user">
                        ...
                        @can('essentials.add_allowance_and_deduction')
                            <button id="pay_componentButton" style="display: none;" type="button" class="add-user-modal-btn btn-modal btn-block btn-primary" data-href="{{action('\Modules\Essentials\Http\Controllers\EssentialsAllowanceAndDeductionController@create')}}" data-container="#add_allowance_deduction_modal">
