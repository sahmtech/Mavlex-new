    ...
    <div class="card-wrapper">
        ...
        <div class="overview-filter">
            ...
            <div style="display: flex; gap: 20px;">
                <div class="new-user">
                    <button type="button" class="add-user-modal-btn btn-modal btn-block btn-primary" data-href="{{action('\Modules\Essentials\Http\Controllers\EssentialsLeaveController@create')}}" data-container="#add_leave_modal">
