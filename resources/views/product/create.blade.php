...
<div class="main-container no-print">
  ...
  <div class="horizontal-scroll">
    @include('layouts.partials.sub_menu.product')
  </div>
        ...
        <div class="col-sm-12">
          ...
          <div class="text-center">
            <div class="btn-group">
              ...
              <button id="opening_stock_button" @if(!empty($duplicate_product) && $duplicate_product->enable_stock == 0) disabled @endif type="submit" value="submit_n_add_opening_stock" class="btn bg-navy submit_product_form">@lang('lang_v1.save_n_add_opening_stock')</button>
              @endcan
              ...
              <button type="submit" value="submit" class="btn bg-navy submit_product_form">@lang('messages.save')</button>
            </div>
