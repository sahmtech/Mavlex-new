...
<div class="storys-container">
    ...
    <a href="{{ action('StockRebuildController@index') }}" class="sub-menu-item {{ request()->segment(1) == 'stock-rebuild' ? 'active' : '' }}">
    ...
    <a href="{{ action('TaxRateController@index') }}"
        class="sub-menu-item {{ request()->segment(1) == 'tax-rates' ? 'active' : '' }}">
