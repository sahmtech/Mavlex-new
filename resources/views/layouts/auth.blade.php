...
@endif
    ...
    <style>
        ...
        <style>
            .login-layout {
                background-image: url('{{ asset('uploads/bg_images/' . $app_settings->login_bg_image_url) }}');
            }
        </style>
        @endif
...
<body>
    ...
    <div class="login-layout">
        ...
        <div class="auth-logo">
            ...
            $logo_light_path = public_path('uploads/app_logos/' . $logo_light);
            $default_logo_path = public_path('img/pictures/logo-light.png');
        @endphp
        
        @if($logo_light && file_exists($logo_light_path))
            <img src="{{ asset('uploads/app_logos/' . $logo_light) }}" alt="logo">
        @elseif(file_exists($default_logo_path))
            <img src="{{ asset('img/pictures/logo-light.png') }}" alt="logo">
        @else
            <div class="logo-text">
