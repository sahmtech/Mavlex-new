...
<div class="main-container no-print">
    <div class="horizontal-scroll">
        @include('layouts.partials.sub_menu.user')
    </div>
        ...
        <section class="content">
          ...
          <ul id="supported-apps-list" style="display: none;">
            ...
            <div class="text-center">
                ...
                {{-- Display the QR code inline --}}
                <img src="data:image/svg+xml;base64,{{ base64_encode($qr_code_url) }}" alt="QR Code">
            </div>
            <p>
            ...
            <form action="{{ route('2fa.setup_verify') }}" method="POST">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        {!! Form::text('one_time_password', null, [ 'class' => 'form-control', 'required', 'placeholder' => __('settings.enter_2fa_code_placeholder')] ) !!}
