...
@section('content')
    ...
    <div class="main-container no-print">
        ...
        <div class="horizontal-scroll">
            @include('layouts.partials.sub_menu.setting')
        </div>
            ...
            <div class="setting-two-grid">
                ...
                <div class="col-sm-6 letter_head_input">
                    <div class="form-group">
                        ...
                        <div class="mt-2">
                            <img 
                                src="{{ asset('public/uploads/invoice_logos/' . $invoice_layout->letter_head) }}" 
            ...
            <div class="row hide-for-letterhead">
                <div class="setting-two-grid">
                    ...
                    <div class="form-box ">
                        ...
                        <div class="mt-2">
                             <img src="{{ asset('public/uploads/invoice_logos/' . $invoice_layout->logo) }}" alt="Current Invoice Logo" style="max-height: 100px; display: block;">
                        </div>
                        @endif
