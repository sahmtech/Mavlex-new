...
<div class="row">
    <div class="col-sm-4">
        <div class="form-group">
            ...
            @if(!empty($logoLight) && file_exists(public_path('uploads/app_logos/' . $logoLight)))
                <div style="margin-top:10px;">
                    <img src="{{ asset('uploads/app_logos/' . $logoLight) }}" alt="Light Logo" style="max-width:100%;">
                </div>
            @endif
        </div>
    </div>
    ...
    <div class="col-sm-4">
        <div class="form-group">
            ...
            @if(!empty($logoDark) && file_exists(public_path('uploads/app_logos/' . $logoDark)))
                <div style="margin-top:10px;">
                    <img src="{{ asset('uploads/app_logos/' . $logoDark) }}" alt="Dark Logo" style="max-width:100%;">
                </div>
            @endif
        </div>
    </div>
    ...
    <div class="col-sm-4">
        <div class="form-group">
            ...
            @if(!empty($favicon) && file_exists(public_path('uploads/app_logos/' . $favicon)))
                <div style="margin-top:10px;">
                    <img src="{{ asset('uploads/app_logos/' . $favicon) }}" alt="Favicon" style="width:32px;height:32px;">
                </div>
            @endif
        </div>
    </div>
