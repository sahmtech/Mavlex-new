<div class="row">
        ...
        <div class="form-group">
            <div class="toggle-wrapper d-flex gap-2 mt-4">
                ...
                <label class="switch" for="enable_theme_change">
                    {!! Form::checkbox(
                        'theme_settings[enable_theme_change]', 
                        1, 
                        $app_settings->theme_settings['enable_theme_change'] ?? false, 
                        ['id' => 'enable_theme_change']
                    ) !!}
    ...
    <div class="col-sm-4">
        <div class="form-group">
            ...
            {!! Form::color(
                ...
                $app_settings->theme_settings['primary_color'] ?? '#FFB600',
    ...
    <div class="col-sm-4">
        <div class="form-group">
            ...
            {!! Form::color(
                ...
                $app_settings->theme_settings['secondary_color'] ?? '#011530',
                ['class' => 'form-control', 'id' => 'secondary_color']
            ) !!}
        </div>
    </div>
    ...
    <div class="col-sm-4">
        <div class="form-group">
            ...
            {!! Form::color(
                'theme_settings[body_color]',
                $app_settings->theme_settings['body_color'] ?? '#F8F9FF',
                ['class' => 'form-control', 'id' => 'body_color']
            ) !!}
        </div>
    </div>
    ...
    <div class="col-sm-4">
        <div class="form-group">
            ...
            {!! Form::color(
                'theme_settings[sidebar_text_color]',
                $app_settings->theme_settings['sidebar_text_color'] ?? '#FFFFFF',
                ['class' => 'form-control', 'id' => 'sidebar_text_color']
            ) !!}
        </div>
    </div>
...
document.getElementById('reset-colors').addEventListener('click', function() {
    // Reset each color input to your intended defaults
    document.getElementById('primary_color').value = '#FFB600';
    document.getElementById('secondary_color').value = '#011530';
    document.getElementById('body_color').value = '#F8F9FF';
    document.getElementById('sidebar_text_color').value = '#FFFFFF';
});
</script>
