...
<div class="main-container no-print">
	...
	<div class="horizontal-scroll">
		@include('layouts.partials.sub_menu.purchase')
	</div>
					...
					<div class="row">
						...
						<div class="col-sm-2">
							<div class="form-group add-new-product-btn">
								<button tabindex="-1" type="button" class="btn btn-modal" data-href="{{action('ProductController@quickAdd')}}" data-container=".quick_add_product_modal">
									<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
