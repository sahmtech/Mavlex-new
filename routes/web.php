...
Route::middleware($middleware)->group(function() {
   ...
   Route::post('2fa/recovery-codes/regenerate', [TwoFactorController::class, 'regenerate_recovery_codes'])->name('2fa.regenerate_recovery_codes');
    ...
    Route::get('export-selling-price-group', [App\Http\Controllers\SellingPriceGroupController::class, 'export']);
    Route::post('import-selling-price-group', [App\Http\Controllers\SellingPriceGroupController::class, 'import']);
